...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
    function InitStep()
    {
        ...
        $wizard->SetDefaultVars(
            Array(
                "company_name" => COption::GetOptionString("quick", "company_name", GetMessage("WIZ_COMPANY_NAME_DEF"), $siteID),
                "company_address" => COption::GetOptionString("quick", "company_address", GetMessage("WIZ_COMPANY_ADDRESS_DEF"), $siteID),
                "company_mail" => COption::GetOptionString("quick", "company_mail", "info@" . $_SERVER["SERVER_NAME"], $siteID),
            )
        );
    }
