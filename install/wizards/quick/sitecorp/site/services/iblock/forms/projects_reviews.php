...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/forms/projects_reviews.xml";
$iblockCode = "projects_reviews_" . WIZARD_SITE_ID;
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "projects/index.php", array('QUICK_IBLOCK_ID_PROJECTS_REVIEWS' => $iblockID));
