...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/forms/questions_answer.xml";
$iblockCode = "questions_answer_" . WIZARD_SITE_ID;
$iblockType = "quick_forms_" . WIZARD_SITE_ID;
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "company/questions/index.php", array('QUICK_IBLOCK_ID_QUESTIONS_ANSWER' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_ROOT_PATH . "/bitrix/php_interface/init.php", array('QUICK_IBLOCK_ID_QUESTIONS_ANSWER' => $iblockID));
