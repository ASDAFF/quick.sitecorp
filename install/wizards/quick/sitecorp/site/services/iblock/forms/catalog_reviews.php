...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/forms/catalog_reviews.xml";
$iblockCode = "catalog_reviews_" . WIZARD_SITE_ID;
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "catalog/index.php", array('QUICK_IBLOCK_ID_CATALOG_REVIEWS' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "_index.php", array('QUICK_IBLOCK_ID_CATALOG_REVIEWS' => $iblockID));
