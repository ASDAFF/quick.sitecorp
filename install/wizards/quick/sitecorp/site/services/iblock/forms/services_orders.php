...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/forms/services_orders.xml";
$iblockCode = "services_orders_" . WIZARD_SITE_ID;
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "services/index.php", array('QUICK_IBLOCK_ID_SERVICES_ORDERS' => $iblockID));
