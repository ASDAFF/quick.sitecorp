...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/forms/catalog_questions.xml";
$iblockCode = "catalog_questions_" . WIZARD_SITE_ID;
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "catalog/index.php", array('QUICK_IBLOCK_ID_CATALOG_QUESTIONS' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "_index.php", array('QUICK_IBLOCK_ID_CATALOG_QUESTIONS' => $iblockID));
