...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "catalog/index.php", array('QUICK_IBLOCK_ID_CATALOG_ORDERS' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "_index.php", array('QUICK_IBLOCK_ID_CATALOG_ORDERS' => $iblockID));
