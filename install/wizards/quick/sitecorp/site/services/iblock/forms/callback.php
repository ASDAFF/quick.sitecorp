...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/forms/callback.xml";
...
CWizardUtil::ReplaceMacros($bitrixTemplateDir . "/footer.php", array('QUICK_IBLOCK_ID_CALLBACK' => $iblockID));
