...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/forms/feedback.xml";
...
CWizardUtil::ReplaceMacros($bitrixTemplateDir . "/footer.php", array('QUICK_IBLOCK_ID_FEEDBACK' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "contacts/index.php", array('QUICK_IBLOCK_ID_FEEDBACK' => $iblockID));
?>