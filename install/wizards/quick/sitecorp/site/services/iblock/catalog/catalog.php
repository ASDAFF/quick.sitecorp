...
$iblockType = "quick_catalog_" . WIZARD_SITE_ID;
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "catalog/index.php", array("QUICK_IBLOCK_ID_CATALOG" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "catalog/.left.menu.php", array("QUICK_IBLOCK_ID_CATALOG" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "catalog/.top_child.menu.php", array("QUICK_IBLOCK_ID_CATALOG" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "_index.php", array("QUICK_IBLOCK_ID_CATALOG" => $iblockID));
CWizardUtil::ReplaceMacros($bitrixTemplateDir . "/footer.php", array("QUICK_IBLOCK_ID_CATALOG" => $iblockID));
