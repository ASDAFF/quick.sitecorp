...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/objects/articles.xml";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "articles/index.php", array('QUICK_IBLOCK_ID_ARTICLES' => $iblockID));
