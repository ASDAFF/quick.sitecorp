...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/objects/partners_on_maps.xml";
$iblockCode = "partners_on_maps_" . WIZARD_SITE_ID;
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "company/partners-on-maps/index.php", array('QUICK_IBLOCK_ID_PARTNERS_OM_MAPS' => $iblockID));
?>