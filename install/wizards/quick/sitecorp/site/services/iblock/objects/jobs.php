...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/objects/jobs.xml";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "company/jobs/index.php", array('QUICK_IBLOCK_ID_JOBS' => $iblockID));
?>