...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/objects/partners.xml";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "company/partners/index.php", array('QUICK_IBLOCK_ID_PARTNERS' => $iblockID));
CWizardUtil::ReplaceMacros($bitrixTemplateDir . "/footer.php", array('QUICK_IBLOCK_ID_PARTNERS' => $iblockID));
