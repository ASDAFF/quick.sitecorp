...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/objects/projects.xml";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "projects/index.php", array('QUICK_IBLOCK_ID_PROJECTS' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "services/index.php", array('QUICK_IBLOCK_ID_PROJECTS' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "projects/.left.menu.php", array('QUICK_IBLOCK_ID_PROJECTS' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "projects/.top_child.menu.php", array('QUICK_IBLOCK_ID_PROJECTS' => $iblockID));
CWizardUtil::ReplaceMacros($bitrixTemplateDir . "/footer.php", array('QUICK_IBLOCK_ID_PROJECTS' => $iblockID));
