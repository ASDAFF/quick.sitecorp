...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/objects/services.xml";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "services/index.php", array('QUICK_IBLOCK_ID_SERVICES' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "projects/index.php", array('QUICK_IBLOCK_ID_SERVICES' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "services/.left.menu.php", array('QUICK_IBLOCK_ID_SERVICES' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "services/.top_child.menu.php", array('QUICK_IBLOCK_ID_SERVICES' => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "_index.php", array('QUICK_IBLOCK_ID_SERVICES' => $iblockID));
CWizardUtil::ReplaceMacros($bitrixTemplateDir . "/header.php", array('QUICK_IBLOCK_ID_SERVICES' => $iblockID));
?>