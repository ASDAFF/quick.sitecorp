...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/objects/news.xml";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "news/index.php", array('QUICK_IBLOCK_ID_NEWS' => $iblockID));
CWizardUtil::ReplaceMacros($bitrixTemplateDir . "/footer.php", array('QUICK_IBLOCK_ID_NEWS' => $iblockID));
