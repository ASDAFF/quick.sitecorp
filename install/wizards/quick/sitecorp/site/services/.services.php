...
$arServices = Array(
    "main" => Array(
        "NAME" => GetMessage("QUICK_SERVICE_MAIN_SETTINGS"),
        "STAGES" => Array(
            "files.php",
            "template.php",
            "theme.php",
    ...
    "iblock" => Array(
        "NAME" => GetMessage("QUICK_SERVICE_IBLOCK"),
        "STAGES" => Array(
            "types.php",
	...
	"sale" => Array(
        "NAME" => GetMessage("QUICK_SERVICE_SALE_DEMO_DATA"),
        "STAGES" => Array(
            "step1.php",
            "step2.php",
            "step3.php"
    ...
    "catalog" => Array(
        "NAME" => GetMessage("QUICK_SERVICE_CATALOG_SETTINGS"),
        "STAGES" => Array(
            "index.php",
        ),
    ),
    "forum" => Array(
        "NAME" => GetMessage("QUICK_SERVICE_FORUM")
    )
);
?>