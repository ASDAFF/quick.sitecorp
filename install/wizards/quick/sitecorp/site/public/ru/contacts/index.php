...
<div class="cols4 contacts">
    ...
    <div class="col2">
        ...
        <br/><br/>
        <?$APPLICATION->IncludeComponent("quick:form", "feedback", array(
                "USE_CAPTCHA" => "Y",
                "EVENT_MESSAGE_ID" => array(),
                "EVENT_MESSAGE_TYPE" => "QUICK_FEEDBACK",
                "EVENT_MESSAGE_TYPE_USER" => "QUICK_FEEDBACK_USER",
                ...
                "QUICK_IBLOCK_ID_RECORD" => "#QUICK_IBLOCK_ID_FEEDBACK#",
            ),
            false
        );?>
    </div>
