    ...
    <div class="inner">
        ...
        <?$APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "IBLOCK_ID" => "#QUICK_IBLOCK_ID_SERVICES#",
                "NEWS_COUNT" => "6",
                "SORT_BY1" => "SORT",
                "SORT_ORDER1" => "ASC",
                "SORT_BY2" => "",
...
<div class="slide pt0">
    <div class="inner">
        ...
        <?$APPLICATION->IncludeComponent("quick:topics.goods", "quick", array(
                "IBLOCK_TYPE" => "quick_catalog_" . SITE_ID,
                "IBLOCK_ID" => "#QUICK_IBLOCK_ID_CATALOG#",
                "COUNT_SECTION" => "4",
    ...
    <div class="inner">
        ...
        <?$APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "QUICK_IBLOCK_ID_ORDER" => "#QUICK_IBLOCK_ID_CATALOG_ORDERS#",
                "QUICK_IBLOCK_ID_QUESTIONS" => "#QUICK_IBLOCK_ID_CATALOG_QUESTIONS#",
                "QUICK_IBLOCK_ID_REVIEWS" => "#QUICK_IBLOCK_ID_CATALOG_REVIEWS#",
                "QUICK_ALLOW_REVIEWS" => "Y",
                "QUICK_ELEMENT_USE_SORT" => "Y",
                "QUICK_PREVIEW_TEXT_DETAIL" => "Y",
                "QUICK_DISPLAY_PROPERTIES_SECTION" => "Y",
                "QUICK_PREVIEW_TEXT_SECTION" => "N",
                "QUICK_PREVIEW_TEXT_SECTION_COUNT" => "300",
                "QUICK_USE_DELAY" => "Y",
                "QUICK_DELAY_PATH" => "#SITE_DIR#ajax/addDelay.php",
                "QUICK_MESS_BTN_DELAY" => "Отложить товар",
                "DISPLAY_COMPARE" => "Y",
