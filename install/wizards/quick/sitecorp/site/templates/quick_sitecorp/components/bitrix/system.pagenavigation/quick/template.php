...
<?if ($arResult["NavShowAll"]){?>
    <div class="pagination_pages"><a href="<?=$arResult['sUrlPathParams']; ?>SHOWALL_<?=$arResult["NavNum"]?>=0&SIZEN_<?=$arResult["NavNum"]?>=<?=$arResult['NavPageSize']; ?>"><?// echo GetMessage('QUICK_SHOW_PAGES'); ?></a></div>
<?} else {?>
    <div class="pagination">
        ...
        <?if ($arResult["NavPageNomer"] < $arResult["NavPageCount"]) {?>
            <a class="pag-next" href="<?=$arResult['sUrlPathParams']; ?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>&SIZEN_<?=$arResult["NavNum"]?>=<?=$arResult['NavPageSize']; ?>" title="<? echo GetMessage('nav_next_title'); ?>"><? //echo GetMessage('QUICK_NEXT'); ?></a>
        <?}?>
    </div>
<?}?>