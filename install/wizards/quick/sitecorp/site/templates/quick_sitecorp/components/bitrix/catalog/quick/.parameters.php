...
$arTemplateParameters = array(
    ...
    "QUICK_ELEMENT_USE_SORT" => Array(
        "PARENT" => "BASE",
        "NAME" => GetMessage("QUICK_ELEMENT_USE_SORT"),
        "TYPE" => "CHECKBOX",
    ),
    "QUICK_PREVIEW_TEXT_DETAIL" => Array(
        "PARENT" => "BASE",
        "NAME" => GetMessage("QUICK_PREVIEW_TEXT_DETAIL"),
        "TYPE" => "CHECKBOX",
    ),
    "QUICK_PREVIEW_TEXT_SECTION" => Array(
        "PARENT" => "BASE",
        "NAME" => GetMessage("QUICK_PREVIEW_TEXT_SECTION"),
        "TYPE" => "CHECKBOX",
    ),
    "QUICK_PREVIEW_TEXT_SECTION_COUNT" => Array(
        "PARENT" => "BASE",
        "NAME" => GetMessage("QUICK_PREVIEW_TEXT_SECTION_COUNT"),
        "TYPE" => "STRING",
    ),
    ...
    "QUICK_MESS_BTN_DELAY" => Array(
        "PARENT" => "BASE",
        "NAME" => GetMessage("QUICK_MESS_BTN_DELAY"),
        "TYPE" => "STRING",
    ),
    "QUICK_DELAY_PATH" => Array(
        "PARENT" => "BASE",
        "NAME" => GetMessage("QUICK_DELAY_PATH"),
        "TYPE" => "STRING",
    ),
);
?>