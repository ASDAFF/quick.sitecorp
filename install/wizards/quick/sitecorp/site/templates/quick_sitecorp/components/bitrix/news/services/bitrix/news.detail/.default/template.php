...
<?if ($arResult['PROPERTIES']['ORDER_SERVICE']['VALUE'] == "Y"){?>
    <div class="cons cons-small in-row-mid">
        <div class="col1">
            <div class="title4"><?=GetMessage('QUICK_SERVICES_ORDER')?></div>
            <p>
        ...
        <div class="col2"><a class="btn popbutton" data-window="2"><?=GetMessage('QUICK_SERVICES_ORDER')?></a></div>
    </div>
<?}?>
...
<?if ($arResult['PROPERTIES']['CONSULTATION_SERVICE']['VALUE'] == "Y"){?>
    <div class="cons cons-small in-row-mid">
        <div class="col1">
            <div class="title4"><?=GetMessage('QUICK_SERVICES_CONSULTATION')?></div>
            <p>
                <?$APPLICATION->IncludeComponent("bitrix:main.include", ".default", array(
                        "AREA_FILE_SHOW" => "file",
        ...
        <div class="col2"><a class="btn4 popbutton" data-window="5"><?=GetMessage('QUICK_SERVICES_CONSULTATION_ASC')?></a></div>
    </div>
<?}?>
            ...
            <?foreach ($arResult['PROPERTIES']['DOCS']['VALUE'] as $docs) {
                ...
                <div class="in-row-bot">
                    ...
                    <div>
                        ...
                        <div><?=GetMessage('QUICK_SERVICES_SIZE')?>: <?=round($doc['FILE_SIZE'] / 1024, 1)?> <?=GetMessage('QUICK_SERVICES_KB')?></div>
                    </div>
                </div>
            <?}?>
        </div>
...
<?if (!empty($arResult['PROPERTIES']['PROJECTS']['VALUE'])){?>
    <div class="projects margin4">
        ...
        <?$APPLICATION->IncludeComponent("bitrix:news.list", "projects_services", array(
                ...
                "IBLOCK_ID" => $arParams['QUICK_IBLOCK_ID_PROJECTS'],
                "NEWS_COUNT" => "10",
                "SORT_BY1" => "SORT",
                "SORT_ORDER1" => "ASC",
                "SORT_BY2" => "SORT",
