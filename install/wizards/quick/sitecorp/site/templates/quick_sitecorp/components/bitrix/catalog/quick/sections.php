...
<div class="cols2">
    <?$APPLICATION->IncludeComponent("bitrix:main.include", ".default", array( "AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR . "include/catalog/banners_top.php", "EDIT_TEMPLATE" => "" ), false );?>
    <?$APPLICATION->IncludeComponent(
    ...
    <?$APPLICATION->IncludeComponent("bitrix:main.include", ".default", array( "AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR . "include/catalog/bottom_text.php", "EDIT_TEMPLATE" => "" ), false );?>

    <?$APPLICATION->IncludeComponent("bitrix:main.include", ".default", array( "AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR . "include/catalog/banners.php", "EDIT_TEMPLATE" => "" ), false );?>
