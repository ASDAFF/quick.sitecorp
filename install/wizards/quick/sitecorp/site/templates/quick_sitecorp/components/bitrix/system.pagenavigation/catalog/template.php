...
<div class="pager">
    <ul>
        <?if ($arResult["NavShowAll"]){?>
            <li class="pagination_pages"><a href="<?=$arResult['sUrlPathParams']; ?>SHOWALL_<?=$arResult["NavNum"]?>=0&SIZEN_<?=$arResult["NavNum"]?>=<?=$arResult['NavPageSize']; ?>"><? echo GetMessage('QUICK_SHOW_PAGES'); ?></a></li>
        <?} else {?>
            <!--prev button-->
            <li>
                <?if (1 < $arResult["NavPageNomer"]) {?>
                    <a href="<?=$arResult['sUrlPathParams']; ?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]-1)?>&SIZEN_<?=$arResult["NavNum"]?>=<?=$arResult['NavPageSize']; ?>" title="<? echo GetMessage('nav_prev_title'); ?>"><? echo GetMessage('QUICK_PREV'); ?></a>
                <?} else {?>
                    <a href="javascript:void(0)"><?=GetMessage('QUICK_PREV');?></a>
                <?}?>
            </li>
            ...
            <li>
                <?if ($arResult["NavPageNomer"] < $arResult["NavPageCount"]) {?>
                    <a href="<?=$arResult['sUrlPathParams']; ?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>&SIZEN_<?=$arResult["NavNum"]?>=<?=$arResult['NavPageSize']; ?>" title="<? echo GetMessage('nav_next_title'); ?>"><? echo GetMessage('QUICK_NEXT'); ?></a>
                <?} else {?>
                    <a href="javascript:void(0)"><?=GetMessage('QUICK_NEXT');?></a>
                <?}?>
            </li>
