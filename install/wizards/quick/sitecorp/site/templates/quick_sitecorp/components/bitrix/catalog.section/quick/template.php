...
<div class="items">
    <?foreach ($arResult['ITEMS'] as $arItem){?>
        ...
        if ($arParams['QUICK_USE_PREVIEW_CATEGORIES_IN_SECTION'] == 'Y'){
        ...
        <div>
            <div>
                <?if (!empty($arPrice['OLD_PRICE'])){?>
                    <div class="label label-red"><span class="sale active"><span><?=GetMessage('QUICK_CATALOG_SECTION_SALE') . $arPrice['PRICE_DIFF']?></span></div>
                ...
                <div class="item-name">
                    ...
                    <?if ($arParams['QUICK_USE_PREVIEW_TEXT_IN_SECTION'] == 'Y'){?>
                ...
                <?if (!empty($arPrice['PRICE'])){?>
                    <div class="price-block">
                        ...
                        <?}?>
                        <?/*if (!empty($arPrice['OLD_PRICE'])){?>
                            <div class="price_diff_box"><?=GetMessage('QUICK_CATALOG_SECTION_SALE')?><span class="price_diff"><?=$arPrice['PRICE_DIFF']?></span></div>
                        <?}*/?>
                    </div>
                <?}?>
                <div class="item-more">
