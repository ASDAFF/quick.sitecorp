        ...
        <?if ($arParams['USE_FILTER'] == 'Y') {
            ...
            <?$APPLICATION->IncludeComponent(
                ...
                Array(
                    ...
                    "QUICK_FILTER_REFERENCE" => $arParams["QUICK_FILTER_REFERENCE"],
    ...
    <div class="col2 catalog-v2">
            ...
            <div class="fll">
                <form action="" method="GET" name="form_bottom">
                    <select class="select" name="sort" onchange="form_bottom.submit();">
                        <option><?=GetMessage('QUICK_CATALOG_SORT_0');?>:</option>
                        <option value="asc_price" <?if($_GET["sort"] == 'asc_price'){echo "selected";}?>><?=GetMessage('QUICK_CATALOG_SORT_1');?></option>
                        <option value="desc_price" <?if($_GET["sort"] == 'desc_price'){echo "selected";}?>><?=GetMessage('QUICK_CATALOG_SORT_2');?></option>
                        <option value="asc_name" <?if($_GET["sort"] == 'asc_name'){echo "selected";}?>><?=GetMessage('QUICK_CATALOG_SORT_3');?></option>
                        <option value="desc_name" <?if($_GET["sort"] == 'desc_name'){echo "selected";}?>><?=GetMessage('QUICK_CATALOG_SORT_4');?></option>
                    </select>
                </form>
            </div>

            <div class="flr view-style">
                <span><?=GetMessage('QUICK_CATALOG_VIEW')?>:</span>
        ...
        <?$APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "QUICK_PREVIEW_TEXT_DETAIL" => $arParams['QUICK_PREVIEW_TEXT_DETAIL'],
                "QUICK_DISPLAY_PROPERTIES_SECTION" => $arParams['QUICK_DISPLAY_PROPERTIES_SECTION'],
                "QUICK_PREVIEW_TEXT_SECTION" => $arParams['QUICK_PREVIEW_TEXT_SECTION'],
                "QUICK_PREVIEW_TEXT_SECTION_COUNT" => $arParams['QUICK_PREVIEW_TEXT_SECTION_COUNT'],
                "QUICK_MESS_BTN_DELAY" => $arParams['QUICK_MESS_BTN_DELAY'],
                "QUICK_USE_DELAY" => $arParams['QUICK_USE_DELAY'],
                "QUICK_DELAY_PATH" => $arParams['QUICK_DELAY_PATH'],
            ),
            $component
        );?>
    </div>
