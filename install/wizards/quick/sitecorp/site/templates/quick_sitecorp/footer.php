<?IncludeTemplateLangFile(__FILE__);?>
        ...
        <?if ($index){?>
                ...
                <div class="inner cols1">
                    ...
                    <div class="col2">
                        ...
                        <?$APPLICATION->IncludeComponent(
                            ...
                            array(
                                "IBLOCK_TYPE" => "quick_objects_" . SITE_ID,
                                "IBLOCK_ID" => "#QUICK_IBLOCK_ID_NEWS#",
                                "NEWS_COUNT" => "2",
            ...
            <?$APPLICATION->IncludeComponent("bitrix:news.list", "partners", array(
                    "IBLOCK_TYPE" => "quick_objects_" . SITE_ID,
                    "IBLOCK_ID" => "#QUICK_IBLOCK_ID_PARTNERS#",
                    "NEWS_COUNT" => "10",
                    "SORT_BY1" => "SORT",
                    "SORT_ORDER1" => "ASC",
                    "SORT_BY2" => "SORT",
...
<div id="1" class="popwindow" data-title="" data-height="auto">
    <div class="popup-wrap1">
        <a class="bw_close"></a>
        <?$APPLICATION->IncludeComponent("quick:form", "callback", array(
                "USE_CAPTCHA" => "Y",
                "EVENT_MESSAGE_ID" => array(),
                "EVENT_MESSAGE_TYPE" => "QUICK_CALLBACK",
                "EVENT_MESSAGE_TYPE_USER" => "QUICK_CALLBACK_USER",
                "OK_TEXT" => "",
                "EMAIL_TO" => "",
                ...
                "AJAX_OPTION_HISTORY" => "N",
                "AJAX_OPTION_ADDITIONAL" => "",
                "QUICK_IBLOCK_ID_RECORD" => "#QUICK_IBLOCK_ID_CALLBACK#",
            ),
            false
        );?>
    </div>
...
<div id="7" class="popwindow" data-title="" data-height="auto">
    <div class="popup-wrap1">
        ...
        <?$APPLICATION->IncludeComponent("quick:form", "services_question", array(
                ...
                "QUICK_IBLOCK_ID_RECORD" => "#QUICK_IBLOCK_ID_QUESTIONS_SERVICES#",
            ),
            false
        );?>
    </div>
...
<!--    bottom fixed menu  <<<    -->
<?/*$APPLICATION->IncludeComponent("quick:fixed.footer.menu", "quick", array(
        "CACHE_TYPE" => "Y",
        "CACHE_TIME" => "3600",
        "CATALOG_IBLOCK_ID" => "#QUICK_IBLOCK_ID_CATALOG#",
    ),
    false
);*/?>
<!--    >>>    bottom fixed menu    -->
