...
<head>
    ...
    <script type="text/javascript">
        ...
        var QUICK_CATALOG_COMPARE_LIST = new Object();
        var QUICK_DELAY_LIST = new Object();
        var QUICK_ADMIN = <?if ($USER->IsAdmin()){?>true<?}else{?>false<?}?>;
    </script>
        ...
        <?if ($index){?>
            <?$APPLICATION->IncludeComponent(
                ...
                array(
                    ...
                    "IBLOCK_ID" => "#QUICK_IBLOCK_ID_SLIDER#",
                    "COUNT_ELEMENTS" => "10",
                    "CACHE_TYPE" => "A",
                    "CACHE_TIME" => "3600",
                    "QUICK_SLIDE_PAUSE" => "4",
